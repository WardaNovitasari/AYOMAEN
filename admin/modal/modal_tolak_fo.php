<?php
    $id_tempat = $id;
    $query = mysqli_query($config,"SELECT * FROM tb_tempat_fiber WHERE id_tempat='$id_tempat'");
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <h4 class="modal-title" id="myModalLabel">Keterangan Tolak Fiber</h4>
                    </div>
                    <div class="modal-body">
                    <form action="../aksi/admin/aksi_tolak_pengajuanfo.php" method="POST">
