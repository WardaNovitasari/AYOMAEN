...
session_start();
  ...
  $pengawas = mysqli_query($config,"SELECT * FROM tb_pegawai WHERE posisi='KA'");
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="card mb-3" id="form-tambah">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <form action="../aksi/admin/tambah_ka.php" method="post"><!--multipart/form-data berfungsi supaya file dapat diambil -->
