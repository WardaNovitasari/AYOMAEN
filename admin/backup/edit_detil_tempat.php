...
session_start();
  ...
  $id=$_GET['id'];
  $lokasimenara = mysqli_query($config,"SELECT * FROM tb_tempat WHERE id='$id'");
  echo $id;
?>
        ...
        <div class="card mb-3">
          ...
          <div class="card-body">
            <div class="table-responsive">
              <?php
                while($rowsPer1 = mysqli_fetch_array($lokasimenara)){
                  ?>
              <form action="../aksi/edit_lokasi_menara.php" method="post" name="myform">
