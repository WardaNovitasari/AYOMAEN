       ...
       <?php include 'view/iconcards.php'; ?>
        ...
        <div class="card mb-3">
          <div class="card-header">
            ...
            Data User yang Menunggu Verifikasi</div>
          <div class="card-body">
            <div class="table-responsive">
              <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                while ($user=mysqli_fetch_array($query)) {
                  if($user['status_akun']=='belum_verifikasi' && $user['level']=='user'){ 
                ?>
                  <tr>
                    <td><center><?php echo $no ?></center></td>
                    <td><?php echo $user['nm_perusahaan']; ?></td>
                    <td><?php echo $user['alamat_perusahaan']; ?></td>
                    <td><p class="text-warning">Menunggu Verifikasi User</p></td>
                    <td><center><a href="../acc.php?id=<?php echo $user['email'];?>" class="smaller btn btn-success" onclick="return confirm('Anda yakin mau menerima data ini ?')"><i class="fas fa-check"></i></a>&nbsp;<a class="smaller btn btn-danger" href='../aksi/delete.php?id=<?php echo $user['id_user']; ?>' onclick="return confirm('Anda yakin mau menghapus akun ini ?')"><i class="fas fa-trash"></i></a></center></td>
                  </tr>
                <?php 
                 $no++;
                  } 
