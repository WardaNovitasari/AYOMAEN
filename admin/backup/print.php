...
$query=mysqli_query($config,"SELECT * FROM tb_tempat WHERE id='$id'");
...
<body>
	...
	<br/>
	Menindaklanjuti Permohonan Rekomendasi Titik Lokasi Menara Telekomunikasi Nomor 087/BFI/XI/2018 dari PT. Borobudur Fiber Indonesia tertanggal 11 Desember 2018, serta berdasarkan :
	<ol>
	...
	<table border="0">
 	...
 	while($data=mysqli_fetch_array($query)){
 	?>
	<tr><td>a. SiteID</td><td>:</td><td><?php echo $data['nama_tempat'];?></td></tr>
