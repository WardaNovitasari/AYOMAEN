...
session_start();
  ...
  $query=mysqli_query($config,"SELECT tb_user.nama,tb_user.nm_perusahaan,tb_user.email,tb_form_menara.id_form,tb_form_menara.status FROM tb_user JOIN tb_form_menara ON tb_user.id_user=tb_form_menara.id_user JOIN tb_tempat ON tb_form_menara.id_form=tb_tempat.id_form WHERE tb_form_menara.status='disetujui' AND tb_user.level=2 AND tb_tempat.status='disetujui' GROUP BY tb_form_menara.id_form ORDER BY tb_form_menara.id_form DESC");
?>
<!DOCTYPE html>
<html lang="en">
              ...
              <table class="table table-striped" id="dataTable" width="100%" cellspacing="0">
                ...
                ?>
                  <tr>
                    ...
                    <td><center><a href="detiltempat2.php?id=<?php echo $menara['id_form']; ?>"><button type="button" class='btn btn-primary' >Detail</button></a></center></td>
                  </tr>
