        ...
        <div class="container-fluid"><button class="btn btn-link d-md-none rounded-circle mr-3" id="sidebarToggleTop" type="button"><i class="fas fa-bars"></i></button>
            ...
            <ul class="nav navbar-nav flex-nowrap ml-auto">
                <li class="nav-item dropdown d-sm-none no-arrow"><a class="dropdown-toggle nav-link" data-toggle="dropdown" aria-expanded="false" href="#"><i class="fas fa-search"></i></a>
                    <div class="dropdown-menu dropdown-menu-right p-3 animated--grow-in sc" role="menu" aria-labelledby="searchDropdown">
                    </div>
                </li>
                      ...
                      <span class="d-none d-lg-inline mr-2 text-gray-600 small">
                        ...
                        <div
                            ...
                            <div
                                ...
                                <a class="dropdown-item" role="presentation" href="#" style="color: #2c3e50;font-weight: bold;font-size: 15px;"><i class="fas fa-user-circle fa-sm fa-fw mr-2 text-gray-400" style="color: #4e73df;font-size: 15px;"></i>&nbsp;User1</a>
