...
if(isset($_GET['id'])){
  $id_tempat=$_GET['id'];
  $step3 = mysqli_query($config,"SELECT * FROM tb_tempat_fiber JOIN tb_form_fiber ON tb_tempat_fiber.id_form=tb_form_fiber.id_form JOIN tb_perusahaan ON tb_form_fiber.id_perusahaan=tb_perusahaan.id_perusahaan JOIN tb_akun ON tb_perusahaan.id_akun=tb_akun.id_akun WHERE tb_akun.username='$username' AND tb_perusahaan.nm_perusahaan='$perusahaan' AND tb_tempat_fiber.status_tempat='pengajuan' AND tb_tempat_fiber.id_tempat=$id_tempat OR tb_akun.username='$username' AND tb_perusahaan.nm_perusahaan='$perusahaan' AND tb_tempat_fiber.status_tempat='belum_dikirim' AND tb_tempat_fiber.id_tempat=$id_tempat OR tb_akun.username='$username' AND tb_perusahaan.nm_perusahaan='$perusahaan' AND tb_tempat_fiber.status_tempat='ditolak' AND tb_tempat_fiber.id_tempat=$id_tempat ORDER BY tb_tempat_fiber.status_tempat");
?>
<html lang="en" >
<head>
   <meta charset="UTF-8">
...
while($data = mysqli_fetch_assoc($step3)){
 ...
 <form action="../aksi/user/aksi_edit_fo_baru.php" class="was-validated" method="POST">
  ...
  <div class="form-group">
    <label for="alamat">Tipe fiber :</label>
    <input type="text" class="form-control" id="tipe_fiber" placeholder="Tipe fiber" name="tipe_menara" required value="<?php echo $data['tipe_menara'];?>">
    <div class="valid-feedback">Valid.</div>
    <div class="invalid-feedback">Please fill out this field.</div>
  </div>
  <div class="form-group">
