...
<div class="container">
    ...
    <table class="table table-bordered">
        ...
        <?php
        if($step==1){
            $sql = "SELECT * FROM tb_tempat_menara JOIN tb_form_menara ON tb_tempat_menara.id_form=tb_form_menara.id_form WHERE tb_tempat_menara.id_form='$id'";
        }elseif($step==2){
            $sql = "SELECT * FROM tb_tempat_menara JOIN tb_form_menara ON tb_tempat_menara.id_form=tb_form_menara.id_form WHERE tb_tempat_menara.id_form='$id' AND tb_tempat_menara.status_tempat='pengajuan' OR tb_tempat_menara.id_form='$id' AND tb_tempat_menara.status_tempat='ditolak' ORDER BY tb_tempat_menara.status_tempat DESC ";
        }elseif($step==3){
        ...
        ?>
            <tr>
            	<?php if($data['status_tempat']=='ditolak'){ ?>
                	...
                	<td><a href="" class="update" data-name="nomor" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Nomor Menara" title="Edit Nomor Tempat"><?php echo $data['nomor'] ?></a></td>

                	<td><a href="" class="update" data-name="site_id" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['site_id'] ?></a></td>
                	<td><a href="" class="update" data-name="alamat" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['alamat'] ?></a></td>
                	<td><a href="" class="update" data-name="kelurahan" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['kelurahan'] ?></a></td>
                	<td><a href="" class="update" data-name="kecamatan" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['kecamatan'] ?></a></td>
                	<td><a href="" class="update" data-name="lat" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['lat'] ?></a></td>
                	<td><a href="" class="update" data-name="lng" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['lng'] ?></a></td>
                	<td><?php echo $data['tipe_menara'] ?></td>
                	<td><a href="" class="update" data-name="tinggi" data-type="text" data-pk="<?php echo $data['id_tempat'] ?>" data-title="Edit Tipe Menara" title="Edit Tipe Menara"><?php echo $data['tinggi'] ?></a></td>
                	...
                	<?php } ?>
                	<td><a href="../aksi/user/delete.php?id=<?php echo $data['id_tempat']?>&tipe=menara" class="btn btn-danger btn-sm"><i class="fas fa-trash"></i></a></td>
            	<?php }else{ ?>
            		<td><?php echo $data['id_form'] ?></td>
                	...
                	<?php }else{ ?>
                		<td><a href="../aksi/user/delete.php?id<?php echo $data['id_tempat']?>&tipe=menara" class="btn btn-danger btn-sm nonaktiv" disabled><i class="fas fa-trash"></i></a></td>
                	<?php } ?>
            	<?php } ?>
            </tr>
        ...
        <tfoot>
        	<tr>
        		...
        		<th colspan="2"><center><a href="info_menara.php?id=<?php echo $id ?>&step=2" class="btn btn-success">Submit</a></center></th>
        	</tr>
        </tfoot>
    </table>
</div> 
