...
<div class="container-fluid">
        ...
        <script>
          //variable array untuk menyimpan marker menara dan fiber optik
           ...
           var iconmenara1 = L.icon({
            iconUrl : '../admin/boostrap/leaflet/images/menara1.png',
            iconSize : [32, 40],
          });

          var iconmenara2 = L.icon({
            iconUrl : '../admin/boostrap/leaflet/images/menara2.png',
            iconSize : [32, 40],
          });
          //variable map
        ...
        <?php
        $query = mysqli_query($config,"SELECT * FROM tb_tempat_menara JOIN tb_form_menara ON tb_tempat_menara.id_form=tb_form_menara.id_form JOIN tb_perusahaan ON tb_form_menara.id_perusahaan = tb_perusahaan.id_perusahaan WHERE tb_perusahaan.nm_perusahaan = '$perusahaan'");
        ...
        ?>
          ...
          marker.bindPopup("<b data-toggle='modal' data-target='#exampleModal<?php echo $result['id_tempat']; ?>' class='point'><?php echo $result['site_id']; ?></b>",{closeOnClick: false, autoClose: false}).openPopup();
        </script>
        <?php
        $id=$result['id_tempat'];
        $jenis='Menara';
...
while($quisioner=mysqli_fetch_array($menara)){
        include '../admin/modal/modal_map.php';
      }
          ...
          marker.bindPopup("<b data-toggle='modal' data-target='#exampleModal<?php echo $result['id_tempat']; ?>' class='point'><?php echo $result['alamat']; ?></b>",{closeOnClick: false, autoClose: false}).openPopup();
        </script>
        <?php
        $id=$result['id_tempat'];
        $jenis='Menara';
