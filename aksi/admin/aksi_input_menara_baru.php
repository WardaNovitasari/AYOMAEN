...
if(isset($_POST['update'])){
	...
	$query1=mysqli_query($config,"UPDATE tb_tempat_menara SET $alamat,$kelurahan,$kecamatan,$lat,$lng,$tipe_menara,$tinggi,$status,$keterangan WHERE $id_tempat");
	if($query1){
		echo "berhasil";
		echo '<script>alert("Data berhasil diupdate");window.location.href="../../admin/pengajuan_menara.php";</script>';
	}else{
		echo "gagal";
	}
}
